...
* params : Serialized JSON object with key = param name, and value = validation regex. Have something as constrained as possible for security, such as \\d+ or \\w+. Make sure to escape backslashes.
